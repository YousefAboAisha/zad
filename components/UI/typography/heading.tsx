type HeadingProps = {
  ...
  const Heading = ({
    ...
    return (
      <h4
        className={`group relative text-3xl md:text-4xl lg:text-5xl font-semibold duration-500 uppercase text-text_light dark:text-text_dark z-10 ${additionalStyles}  `}
      >
        {title}
        <div
