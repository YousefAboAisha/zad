      ...
      <div className="container flex flex-col gap-4 absolute right-0 h-full w-full backdrop-blur-none md:w-[50%] md:backdrop-blur-sm lg:w-[50%] lg:backdrop-blur-sm  items-center justify-center">
        <div className="w-10/12 md:w-10/12 lg:w-7/12">
          <Heading
            ...
            details="منصة زاد هي منصة تعمل عن بُعد وتهدف إلى توفير تجربة تواصل مثالية بين الشركات والطلاب. نحن نوفر بيئة افتراضية حيث يمكن للشركات وأصحاب العمل إيجاد المواهب المناسبة والمؤهلة لمشاريعهم ووظائفهم الحالية والمستقبلية."
